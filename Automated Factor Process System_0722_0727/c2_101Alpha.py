...
def get_alpha(df):
        ...
        df['alpha003_1']=stock.alpha003_1()
        df['alpha003_2']=stock.alpha003_2()
        ...
        df['alpha028_1']=stock.alpha028_1()
        df['alpha028_2']=stock.alpha028_2()
        ...
        df['alpha035_1']=stock.alpha035_1()
        df['alpha035_2']=stock.alpha035_2()
        ...
        df['alpha042_1']=stock.alpha042_1()
        df['alpha042_2']=stock.alpha042_2()
        ...
        df['alpha054_1']=stock.alpha054_1()
        df['alpha054_2']=stock.alpha054_2()
        ...
        df['alpha063']=stock.alpha063()
        df['alpha064']=stock.alpha064()
        df['alpha065']=stock.alpha065()
        df['alpha066']=stock.alpha066()
        df['alpha067']=stock.alpha067()
        df['alpha068']=stock.alpha068()
        df['alpha069']=stock.alpha069()
        df['alpha070']=stock.alpha070()
